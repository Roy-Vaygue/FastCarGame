package com.example.FastCar.model.game;
...
import com.example.FastCar.model.splash.SplashActivity;
...
public class GameActivity extends AppCompatActivity {
    ...
    public static final int ROCK_DELAY_EASY = 600;     //600ms=0.6s
    public static final int ROCK_DELAY_HARD = 300;     //300ms=0.3s
    ...
    private Runnable rockCreateRunnable = new Runnable() {
        ...
        public void run() {
            ...
            if (thePlayer.getNumOfLife() == 0) {                     //game over
                ...
                rockHandler.postDelayed(this, speed);       //run again after delay(speed sec)
        }
    };
    ...
    private void create_mat_option() {
        ...
        mat_IMG_id.add(R.drawable.oil);
        mat_IMG_id.add(R.drawable.gold_coin);
